...
public class RotateClockwise90 implements Rotate90 {
    ...
    public BufferedImage rotate(BufferedImage imgOld) {
        AffineTransform at = AffineTransform.getRotateInstance(Math.toRadians(90), (int)(imgOld.getWidth()/2), (int)(imgOld.getHeight()/2));       //initialize and configure transformation
