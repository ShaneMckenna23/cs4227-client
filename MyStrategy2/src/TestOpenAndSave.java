...
public class TestOpenAndSave {
    public static boolean isToolsOpen, isAdjustmentsOpen, isImageOpen;
    public static JFrame aFrame, iFrame, mFrame, tFrame;
    ...
    public static void main(String[] args) throws Exception {
        ...
        //frame.pack();
        tFrame.setSize(220, 500);
        tFrame.setLocation((dim.width/2-iFrame.getSize().width/2)-tFrame.getSize().width, ( dim.height/2-iFrame.getSize().height/2 ));
